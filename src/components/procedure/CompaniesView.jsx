...
export default function CompaniesView({
  ...
  if (loading && companies.length === 0) {
    return <LoadingSpinner message="Loading procedures..." />;
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                Manage company procedures across all Companies
              </p>
            </div>
          </div>
            ...
            <div className="relative">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center gap-1">
                  {company.type === 'procedure_company' && userAccess?.is_admin && (
                    <>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
              ...
              <div onClick={() => onSelectCompany(company)}>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {company.type === 'procedure_company' && (
                ...
                <div className="flex items-center gap-4 text-xs">
                  ...
                  <div className={`flex items-center gap-1 ${darkMode ? "text-gray-500" : "text-gray-500"}`}>
                    ...
                    <span>{company.total_procedure_count || 0} procedures</span>
                  </div>
                </div>
              </div>
            </div>
