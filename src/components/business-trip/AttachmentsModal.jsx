// ============================================
// File: components/business-trip/AttachmentsModal.jsx
// ============================================
...
export const AttachmentsModal = ({
  ...
  const loadAttachments = async () => {
    setLoading(true);
    try {
      const data = await BusinessTripService.getRequestAttachments(requestId);
  ...
  const handleUpload = async () => {
    ...
    setUploading(true);
    try {
      await BusinessTripService.bulkUploadAttachments(requestId, uploadFiles);
      setUploadFiles([]);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await BusinessTripService.deleteAttachment(attachmentToDelete.id);
      await loadAttachments();
      if (onUpdate) onUpdate();
  ...
  const getFileIcon = (fileType) => {
    const iconType = BusinessTripHelpers.getFileIcon(fileType);
